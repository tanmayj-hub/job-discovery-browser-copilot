        ...
        print(
            {
                ...
                "jobs_relevant_current_run": result.jobs_relevant,
                "jobs_persisted_current_run": len(result.jobs_saved),
                "jobs_new": result.jobs_inserted,
                "jobs_updated": result.jobs_updated,
                "jobs_unchanged": result.jobs_unchanged,
                "active_saved_jobs": getattr(result, "active_saved_jobs", 0),
                "review_export_rows": getattr(result, "review_export_rows", 0),
