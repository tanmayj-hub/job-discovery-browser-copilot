        ...
        rows.append(
            {
                ...
                "Scope Status": source.get("source_scope_status") or "-",
                "Scope Confirmed": bool(source.get("source_scope_confirmed", False)),
                "Scope Method": source.get("source_scope_method") or "-",
                "Scope Reason": source.get("source_scope_reason") or "-",
                "Source URL Used": source.get("source_url_used") or "-",
                ...
                "Non-Canada Rejected": int(source.get("non_canada_rejected", 0) or 0),
                "Unknown Location Relevant": int(source.get("unknown_location_relevant", 0) or 0),
                "Broad Diagnostic": bool(source.get("broad_diagnostic_collection", False)),
