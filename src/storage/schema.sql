...
CREATE TABLE IF NOT EXISTS sources (
    ...
    source_scope_status TEXT,
    source_scope_confirmed INTEGER NOT NULL DEFAULT 0,
    source_scope_method TEXT,
    source_scope_reason TEXT,
    source_url_used TEXT,
    broad_diagnostic_collection INTEGER NOT NULL DEFAULT 0,
    non_canada_rejected INTEGER NOT NULL DEFAULT 0,
    unknown_location_relevant INTEGER NOT NULL DEFAULT 0,
